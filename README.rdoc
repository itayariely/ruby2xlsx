...
This gem is Forked gem based on "Ruby2xlsx" with one changed:
Instead of 'writeexcel' that generates xls I use 'write_xlsx' that generates xlsx

== Install

Add gem to your Gemfile:

  gem "ruby2xlsx", :git => "https://github.com/itayariely/ruby2xlsx.git"
...
1. https://github.com/cxn03651/write_xlsx
